...
class ExpensesTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->requirePresence('expenditure_statement', 'create')
            ->notEmpty('expenditure_statement');
    ...
    public function findExpenseDetailSummary($query, $options){
         $query->select(['sumAmount'=>'SUM(amount)'])->hydrate(false);
         return $query;
    }
}
